...
// 定义 Ref 暴露的接口
export interface ChatSessionListRef {
...
const ChatSessionList = forwardRef<ChatSessionListRef, ChatSessionListProps>(
  (
    {
      onSessionChange,
      onCreateNewSession,
    ...
    // 使用 useImperativeHandle 暴露 loadSessionDetail 方法
    ...
    ); // <-- Correct closing for the forwardRef function body
  },
); // <-- Correct closing for the forwardRef call itself
